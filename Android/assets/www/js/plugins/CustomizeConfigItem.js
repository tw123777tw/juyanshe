 ...
 *
 * @param 数值项目
 * @desc 要添加的数字项目的可选项目信息。
 * @default
 * @type struct<NumberData>[]
 *
 * @param 文字项目
 * @desc 这是要添加的文字项目的可选项目信息。。
 * @default
 * @type struct<StringData>[]
 *
 * @param 布尔值项目
 * @desc 要添加的开关项目的可选项目信息。。
 * @default
 * @type struct<BooleanData>[]
 *
 * @param 音量项目
 * @desc 这是要添加的音量项目的可选项目信息。。
 * @default
...
(function() {
    ...
    //=============================================================================
    var param           = {};
    param.numberOptions = getParamArrayJson(['NumberOptions', '数值项目'], []);
    param.stringOptions = getParamArrayJson(['StringOptions', '文字项目'], []);
    param.switchOptions = getParamArrayJson(['SwitchOptions', '布尔值项目'], []);
    param.volumeOptions = getParamArrayJson(['VolumeOptions', '音量项目'], []);
    ...
    Window_Options.prototype.statusText = function(index) {
        ...
        var value  = this.getConfigValue(symbol);
		  if (symbol == 'Number1' ) {
            result = this.numberStatusText1(value);
        } else
...
Window_Options.prototype.isNumberSymbol1 = function(symbol) {
        return symbol.contains('Number1');
    };
    ...
    Window_Options.prototype.numberStatusText1 = function(value) {
	 return value + "%";
    };
